"""Regression checks for the forge-chain-mempool-lab casebook."""
...
from casebook.harness import assert_expected, forge_chain_mempool_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_chain_mempool_lab_summary(), assert_expected())

...
forge-chain-mempool-lab is a C project for blockchain tooling. It focuses on this technical goal: Implement a C blockchain tooling project for mempool format conversion, using round-trip fixtures and lossless normalization checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 166, risk penalty 6, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
